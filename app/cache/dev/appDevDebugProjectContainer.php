...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'core.common' => 'getCore_CommonService',
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ContractBundle', ($this->targetDirs[2].'/Resources/ContractBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ContractBundle', ($this->targetDirs[3].'/src/ContractBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    /**
     * Gets the 'core.common' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \CoreBundle\CommonClass\Common A CoreBundle\CommonClass\Common instance
     */
    protected function getCore_CommonService()
    {
        return $this->services['core.common'] = new \CoreBundle\CommonClass\Common();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => 21, 'dbname' => 'ahlaajjj_oilandgas', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/DatabaseBundle/Entity'))), 'DatabaseBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'DatabaseBundle' => 'DatabaseBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_4131ef8a1e66e8eeb5de69e1145f4b3550b193a5bcd43898140948ffee1e1737');
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('DatabaseBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('DatabaseBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form'] = $this->get('form.factory')->createNamed('fos_user_resetting_form', 'FOS\\UserBundle\\Form\\Type\\ResettingFormType', NULL, array('validation_groups' => array(0 => 'ResetPassword', 1 => 'Default')));
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'DatabaseBundle\\Entity\\User');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/change-password');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/');

        $n = new \Symfony\Component\HttpFoundation\RequestMatcher('^/home');

        $o = new \Symfony\Component\HttpFoundation\RequestMatcher('^/contracts');

        $p = new \Symfony\Component\HttpFoundation\RequestMatcher('^/aircraft');

        $q = new \Symfony\Component\HttpFoundation\RequestMatcher('^/oilIndustry');

        $r = new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin');

        $s = new \Symfony\Component\HttpFoundation\RequestMatcher('^/_console');

        $t = new \Symfony\Component\Security\Http\AccessMap();
        $t->add($i, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $t->add($j, array(0 => 'ROLE_ADMIN'), NULL);
        ...
        $t->add($s, array(0 => 'IS_SUPER_ADMIN'), NULL);

        $u = new \Symfony\Component\Security\Http\HttpUtils($e, $e);

        $v = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), 'ff0136cdadc5b935154f2ee291d31a1bd6454a2a', 'main', array('name' => 'REMEMBERME', 'lifetime' => 31536000, 'path' => '/', 'domain' => NULL, 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);

        $w = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $u, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($u, '/login'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'fos_user_security_logout'));
        ...
        $x->setOptions(array('login_path' => 'fos_user_security_login', 'default_target_path' => '/home', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $x->setProviderKey('main');

        $y = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($f, $u, array(), $a);
        $y->setOptions(array('login_path' => 'fos_user_security_login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        $z = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $g, $h, $u, 'main', $x, $y, array('check_path' => 'fos_user_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $d, $this->get('security.csrf.token_manager'));
        $z->setRememberMeServices($v);

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($t, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $c), 'main', $a, $d), 2 => $w, 3 => $z, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($b, $v, $g, $a, $d, true, $h), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '5a5df4bb38aad6.92294190', $a, $g), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $t, $g)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $u, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $u, 'fos_user_security_login', false), NULL, NULL, $a, false));
    }
    ...
    {
        return $this->services['swiftmailer.mailer.default.spool'] = new \Swift_FileSpool((__DIR__.'/swiftmailer/spool/default'));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('noreply@ahlab.website');
        $a->setPassword('airbus123#');
        $a->setAuthMode('login');

        $this->services['swiftmailer.mailer.default.transport.real'] = $instance = new \Swift_Transport_EsmtpTransport(new \Swift_Transport_StreamBuffer(new \Swift_StreamFilters_StringReplacementFilterFactory()), array(0 => $a), $this->get('swiftmailer.mailer.default.transport.eventdispatcher'));

        $instance->setHost('ahlab.website');
    ...
    {
        return $this->services['swiftmailer.mailer.plugin.antiflood'] = new \Swift_Plugins_AntiFloodPlugin(99, 60);
    }
    ...
    {
        return $this->services['swiftmailer.plugin.impersonate'] = new \Swift_Plugins_ImpersonatePlugin('noreply@ahlab.website');
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), false, array(), array(0 => 'ContractBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/DatabaseBundle/Resources/views'), 'Database');
        $instance->addPath(($this->targetDirs[3].'/src/AdminToolsBundle/Resources/views'), 'AdminTools');
        $instance->addPath(($this->targetDirs[3].'/src/OilIndustryBundle/Resources/views'), 'OilIndustry');
        $instance->addPath(($this->targetDirs[3].'/src/CoreBundle/Resources/views'), 'Core');
        $instance->addPath(($this->targetDirs[3].'/src/AircraftBundle/Resources/views'), 'Aircraft');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('ff0136cdadc5b935154f2ee291d31a1bd6454a2a');
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('fos_user.user_provider.username_email'), $a, 'main', $this->get('security.encoder_factory'), true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\RememberMeAuthenticationProvider($a, 'ff0136cdadc5b935154f2ee291d31a1bd6454a2a', 'main'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a5df4bb38aad6.92294190')), true);
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_USER' => array(), 'ROLE_ADMIN' => array(0 => 'ROLE_USER'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_USER', 1 => 'ROLE_ADMIN')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'DatabaseBundle' => 'DatabaseBundle\\DatabaseBundle',
                'AdminToolsBundle' => 'AdminToolsBundle\\AdminToolsBundle',
                'OilIndustryBundle' => 'OilIndustryBundle\\OilIndustryBundle',
                'CoreBundle' => 'CoreBundle\\CoreBundle',
                'AircraftBundle' => 'AircraftBundle\\AircraftBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'ContractBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/ContractBundle'),
                    'namespace' => 'ContractBundle',
                ),
                'DatabaseBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/DatabaseBundle'),
                    'namespace' => 'DatabaseBundle',
                ),
                'AdminToolsBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/AdminToolsBundle'),
                    'namespace' => 'AdminToolsBundle',
                ),
                'OilIndustryBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/OilIndustryBundle'),
                    'namespace' => 'OilIndustryBundle',
                ),
                'CoreBundle' => array(
                    'parent' => NULL,
                ...
                'AircraftBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/AircraftBundle'),
                    'namespace' => 'AircraftBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
            ...
            'database_port' => 21,
            'database_name' => 'ahlaajjj_oilandgas',
            'database_user' => 'root',
            'database_password' => 'root',
            'mailer_transport' => 'smtp',
            'mailer_host' => 'ahlab.website',
            'mailer_user' => 'noreply@ahlab.website',
            'mailer_password' => 'airbus123#',
            'mailer_port' => 465,
            'secret' => 'ff0136cdadc5b935154f2ee291d31a1bd6454a2a',
            'locale' => 'en',
            'files_directory' => ($this->targetDirs[2].'/../web/uploads/files'),
            ...
            'kernel.secret' => 'ff0136cdadc5b935154f2ee291d31a1bd6454a2a',
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => 'ahlab.website',
            'swiftmailer.mailer.default.transport.smtp.username' => 'noreply@ahlab.website',
            'swiftmailer.mailer.default.transport.smtp.password' => 'airbus123#',
            'swiftmailer.mailer.default.transport.smtp.auth_mode' => 'login',
            'swiftmailer.mailer.default.transport.smtp.timeout' => 30,
            'swiftmailer.mailer.default.transport.smtp.source_ip' => NULL,
            'swiftmailer.mailer.default.transport.smtp.local_domain' => NULL,
            'swiftmailer.spool.default.file.path' => (__DIR__.'/swiftmailer/spool/default'),
            'swiftmailer.mailer.default.spool.enabled' => true,
            'swiftmailer.mailer.default.sender_address' => 'noreply@ahlab.website',
            'swiftmailer.sender_address' => 'noreply@ahlab.website',
            'swiftmailer.mailer.default.antiflood.threshold' => 99,
            'swiftmailer.mailer.default.antiflood.sleep' => 60,
            ...
            'fos_user.model.user.class' => 'DatabaseBundle\\Entity\\User',
            ...
            'fos_user.resetting.email.from_email' => array(
                'passwordResetting@noreply.com' => 'OilAndGasApplication',
            ),
