 ...
 */
class HelicopterCategory extends \DatabaseBundle\Entity\HelicopterCategory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'DatabaseBundle\\Entity\\HelicopterCategory' . "\0" . 'id', '' . "\0" . 'DatabaseBundle\\Entity\\HelicopterCategory' . "\0" . 'helicopterCategoryName', '' . "\0" . 'DatabaseBundle\\Entity\\HelicopterCategory' . "\0" . 'aircraftFleet'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (HelicopterCategory $proxy) {
    ...
    public function setHelicopterCategoryName($helicopterCategoryName)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setHelicopterCategoryName', [$helicopterCategoryName]);

        return parent::setHelicopterCategoryName($helicopterCategoryName);
    }
    ...
    public function getHelicopterCategoryName()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getHelicopterCategoryName', []);

        return parent::getHelicopterCategoryName();
    }
