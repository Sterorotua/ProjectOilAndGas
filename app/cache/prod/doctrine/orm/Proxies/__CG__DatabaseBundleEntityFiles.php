 ...
 */
class Files extends \DatabaseBundle\Entity\Files implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'DatabaseBundle\\Entity\\Files' . "\0" . 'id', '' . "\0" . 'DatabaseBundle\\Entity\\Files' . "\0" . 'filePath', '' . "\0" . 'DatabaseBundle\\Entity\\Files' . "\0" . 'file'];
        }
