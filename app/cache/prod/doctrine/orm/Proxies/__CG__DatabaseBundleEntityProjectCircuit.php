 ...
 */
class ProjectCircuit extends \DatabaseBundle\Entity\ProjectCircuit implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'DatabaseBundle\\Entity\\ProjectCircuit' . "\0" . 'id', '' . "\0" . 'DatabaseBundle\\Entity\\ProjectCircuit' . "\0" . 'orderNumber', '' . "\0" . 'DatabaseBundle\\Entity\\ProjectCircuit' . "\0" . 'project', '' . "\0" . 'DatabaseBundle\\Entity\\ProjectCircuit' . "\0" . 'platform', '' . "\0" . 'DatabaseBundle\\Entity\\ProjectCircuit' . "\0" . 'operationalMode'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProjectCircuit $proxy) {
    ...
    public function setOperationalMode(\DatabaseBundle\Entity\OperationalMode $operationalMode)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setOperationalMode', [$operationalMode]);

        return parent::setOperationalMode($operationalMode);
    }
    ...
    public function getOperationalMode()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getOperationalMode', []);

        return parent::getOperationalMode();
    }
