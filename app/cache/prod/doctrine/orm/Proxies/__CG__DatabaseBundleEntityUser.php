 ...
 */
class User extends \DatabaseBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'DatabaseBundle\\Entity\\User' . "\0" . 'firstName', '' . "\0" . 'DatabaseBundle\\Entity\\User' . "\0" . 'lastName', '' . "\0" . 'DatabaseBundle\\Entity\\User' . "\0" . 'projectComments', '' . "\0" . 'DatabaseBundle\\Entity\\User' . "\0" . 'helicopterComments', '' . "\0" . 'DatabaseBundle\\Entity\\User' . "\0" . 'service', '' . "\0" . 'DatabaseBundle\\Entity\\User' . "\0" . 'businessArea', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt'];
        }
    ...
    public function setBusinessArea(\DatabaseBundle\Entity\BusinessArea $businessArea = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setBusinessArea', [$businessArea]);

        return parent::setBusinessArea($businessArea);
    }
    ...
    public function getBusinessArea()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getBusinessArea', []);

        return parent::getBusinessArea();
    }
