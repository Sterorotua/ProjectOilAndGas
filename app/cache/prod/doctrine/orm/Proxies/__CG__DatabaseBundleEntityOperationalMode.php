 ...
 */
class OperationalMode extends \DatabaseBundle\Entity\OperationalMode implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'DatabaseBundle\\Entity\\OperationalMode' . "\0" . 'id', '' . "\0" . 'DatabaseBundle\\Entity\\OperationalMode' . "\0" . 'comment', '' . "\0" . 'DatabaseBundle\\Entity\\OperationalMode' . "\0" . 'circuit', '' . "\0" . 'DatabaseBundle\\Entity\\OperationalMode' . "\0" . 'alternate'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OperationalMode $proxy) {
