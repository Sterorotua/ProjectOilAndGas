 ...
 */
class Block extends \DatabaseBundle\Entity\Block implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'DatabaseBundle\\Entity\\Block' . "\0" . 'id', '' . "\0" . 'DatabaseBundle\\Entity\\Block' . "\0" . 'blockNumber'];
        }
    ...
    public function setBlockNumber($blockNumber)
    {
        ...
        return parent::setBlockNumber($blockNumber);
    }
